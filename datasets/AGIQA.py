...
class AGIQA(DatasetBase):

    dataset_dir = '/hd2/wangzichuan/AGIQA-3K'

    def __init__(self, cfg):
        self.root = '/hd2/wangzichuan/AGIQA-3K'
    ...
    def _process_data(self, data, csv_name):
        dataset = []
        csv_filename = '/hd2/wangzichuan/CLIP-AGIQA/datasets/AGIQA/' + csv_name + '/' + csv_name + '.csv'
